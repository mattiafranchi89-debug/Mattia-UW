      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0 flex items-center">
            <svg className="h-8 w-auto text-red-500" fill="currentColor" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 className="text-xl font-semibold text-gray-900 ml-3">Insurance Underwriting Workbench</h1>
          </div>
